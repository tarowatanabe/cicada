...
namespace cicada
{
  ...
  struct ComposeEarley
  {
   ...
   struct edge_unique_hash_type : public utils::hashxx<size_t>
   {
    ...
    struct edge_active_hash_type : public utils::hashxx<size_t>
    {
      size_t operator()(const edge_type* x) const
      {
	return utils::hashxx<size_t>::operator()(x->last.second, x->last.first);
      }
    };
    ...
    struct edge_passive_hash_type : public utils::hashxx<size_t>
    {
      size_t operator()(const edge_type* x) const
      {
	return utils::hashxx<size_t>::operator()(x->first.second, x->first.first);
      }
    };
    ...
    typedef utils::compact_map<transducer_id_type, hypergraph_type::id_type, 
			       ...
			       utils::hashxx<size_t>, std::equal_to<transducer_id_type>,
    ...
    typedef utils::compact_set<hypergraph_type::id_type,
			       ...
			       utils::hashxx<size_t>, std::equal_to<hypergraph_type::id_type>,
