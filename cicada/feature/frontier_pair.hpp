...
#ifndef __CICADA__FEATURE__FRONTIER_PAIR__HPP__
#define __CICADA__FEATURE__FRONTIER_PAIR__HPP__ 1
...
namespace cicada
{
  namespace feature
  {
    class FrontierPairImpl;
    
    class FrontierPair : public FeatureFunction
    {
    public:
    ...
    private:
      ...
      typedef FrontierPairImpl impl_type;
    ...
    public:
      ...
      FrontierPair(const std::string& parameter);
      FrontierPair(const FrontierPair&);
      ~FrontierPair();
      
      FrontierPair& operator=(const FrontierPair&);
    ...
    public:
      ...
      virtual feature_function_ptr_type clone() const { return feature_function_ptr_type(new FrontierPair(*this)); }
