...
#ifndef __CICADA__FEATURE__DISTORTION__HPP__
#define __CICADA__FEATURE__DISTORTION__HPP__ 1
...
namespace cicada
{
  namespace feature
  {
    ...
    class Distortion : public FeatureFunction
    {
    public:
    ...
    private:
      ...
      typedef DistortionImpl        impl_type;
      
    public:
      Distortion(const std::string& parameter);
      Distortion(const Distortion&);
      
      ~Distortion();
      
      Distortion& operator=(const Distortion&);
    ...
    public:
      ...
      virtual feature_function_ptr_type clone() const { return feature_function_ptr_type(new Distortion(*this)); }
