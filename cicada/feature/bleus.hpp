...
#ifndef __CICADA__FEATURE__BLEUS__HPP__
#define __CICADA__FEATURE__BLEUS__HPP__ 1
...
namespace cicada
{
  namespace feature
  {
    ...
    private:
      ...
      typedef BleuSImpl impl_type;
      
    public:
      BleuS(const std::string& parameter);
      BleuS(const BleuS&);
      ~BleuS();

      BleuS& operator=(const BleuS&);
    ...
    public:
      ...
      virtual feature_function_ptr_type clone() const { return feature_function_ptr_type(new BleuS(*this)); }
