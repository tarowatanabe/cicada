...
#ifndef __CICADA__FEATURE__FRONTIER_SHAPE__HPP__
#define __CICADA__FEATURE__FRONTIER_SHAPE__HPP__ 1
...
namespace cicada
{
  namespace feature
  {
    class FrontierShapeImpl;
    
    class FrontierShape : public FeatureFunction
    {
    public:
    ...
    private:
      ...
      typedef FrontierShapeImpl impl_type;
    ...
    public:
      ...
      FrontierShape(const std::string& parameter);
      FrontierShape(const FrontierShape&);
      ~FrontierShape();
      
      FrontierShape& operator=(const FrontierShape&);
    ...
    public:
      ...
      virtual feature_function_ptr_type clone() const { return feature_function_ptr_type(new FrontierShape(*this)); }
