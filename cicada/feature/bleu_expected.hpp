...
#ifndef __CICADA__FEATURE__BLEU_EXPECTED__HPP__
#define __CICADA__FEATURE__BLEU_EXPECTED__HPP__ 1
...
namespace cicada
{
  namespace feature
  {
    ...
    public:
      ...
      BleuExpected(const BleuExpected&);
      ~BleuExpected();

      BleuExpected& operator=(const BleuExpected&);
