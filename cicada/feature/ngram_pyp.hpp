...
#ifndef __CICADA__FEATURE__NGRAM_PYP__HPP__
#define __CICADA__FEATURE__NGRAM_PYP__HPP__ 1
...
namespace cicada
{
  namespace feature
  {
    ...
    class NGramPYP : public FeatureFunction
    {
    public:
    ...
    private:
      ...
      typedef NGramPYPImpl    impl_type;
    ...
    public:
      ...
      NGramPYP(const std::string& parameter);
      NGramPYP(const NGramPYP&);
      ~NGramPYP();
      
      NGramPYP& operator=(const NGramPYP&);
    ...
    public:
      ...
      virtual feature_function_ptr_type clone() const { return feature_function_ptr_type(new NGramPYP(*this)); }
