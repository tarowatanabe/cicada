...
#ifndef __CICADA__FEATURE__PERMUTE__HPP__
#define __CICADA__FEATURE__PERMUTE__HPP__ 1
...
namespace cicada
{
  namespace feature
  {
    ...
    class Permute : public FeatureFunction
    {
    public:
    ...
    private:
      ...
      typedef PermuteImpl        impl_type;
      
    public:
      Permute(const std::string& parameter);
      Permute(const Permute&);
      
      ~Permute();
      Permute& operator=(const Permute&);
