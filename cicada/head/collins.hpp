...
namespace cicada
{
  namespace head
  {
	...
	categories["[ADJP]"]  = ba::list_of<category_list_type>(left, ba::list_of("[NNS]")("[QP]")("[NN]")("[$]")("[ADVP]")("[JJ]")("[VBN]")("[VBG]")
								("[ADJP]")("[JJR]")("[NP]")("[JJS]")("[DT]")("[FW]")("[RBR]")("[RBS]")
								("[SBAR]")("[RB]"));
	
	categories["[ADVP]"]  = ba::list_of<category_list_type>(right, ba::list_of("[RB]")("[RBR]")("[RBS]")("[FW]")("[ADVP]")("[TO]")("[CD]")("[JJR]")
								("[JJ]")("[IN]")("[NP]")("[JJS]")("[NN]"));
	...
	categories["[NAC]"]   = ba::list_of<category_list_type>(left, ba::list_of("[NN]")("[NNS]")("[NNP]")("[NNPS]")("[NP]")("[NAC]")("[EX]")("[$]")
								("[CD]")("[QP]")("[PRP]")("[VBG]")("[JJ]")("[JJS]")("[JJR]")("[ADJP]")
								("[FW]"));
	categories["[NX]"]    = ba::list_of<category_list_type>(left, category_set_type());
	categories["[PP]"]    = ba::list_of<category_list_type>(right, ba::list_of("[IN]")("[TO]")("[VBG]")("[VBN]")("[RP]")("[FW]"));
	...
	categories["[QP]"]    = ba::list_of<category_list_type>(left, ba::list_of("[$]")("[IN]")("[NNS]")("[NN]")("[JJ]")("[RB]")("[DT]")("[CD]")
								("[NCD]")("[QP]")("[JJR]")("[JJS]"));
	categories["[PPC]"]   = ba::list_of<category_list_type>(right, ba::list_of("[VP]")("[NP]")("[ADVP]")("[ADJP]")("[PP]"));
	categories["[S]"]     = ba::list_of<category_list_type>(left, ba::list_of("[TO]")("[IN]")("[VP]")("[S]")("[SBAR]")("[ADJP]")("[UCP]")("[NP]"));
	categories["[SBAR]"]  = ba::list_of<category_list_type>(left, ba::list_of("[WHNP]")("[WHPP]")("[WHADVP]")("WHADJP]")("[IN]")("[DT]")("[S]")("[SQ]")
								("[SINV]")("[SBAR]")("[FRAG]"));
      }
