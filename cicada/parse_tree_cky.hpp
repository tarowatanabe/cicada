...
namespace cicada
{
  ...
  struct ParseTreeCKY
  {
    ...
    typedef typename utils::unordered_map<tree_transducer_type::id_type, tree_candidate_set_type, utils::hashxx<size_t>, std::equal_to<tree_transducer_type::id_type>,
					  std::allocator<std::pair<const tree_transducer_type::id_type, tree_candidate_set_type> > >::type tree_candidate_map_type;
    typedef typename utils::unordered_map<transducer_type::id_type, rule_candidate_set_type, utils::hashxx<size_t>, std::equal_to<transducer_type::id_type>,
    ...
    typedef typename utils::unordered_set<const tree_candidate_type*, utils::hashxx<size_t>, std::equal_to<const tree_candidate_type*>,
					  std::allocator<const tree_candidate_type*> >::type unary_tree_set_type;
    typedef typename utils::unordered_set<const rule_candidate_type*, utils::hashxx<size_t>, std::equal_to<const rule_candidate_type*>,
    ...
    typedef typename utils::unordered_map<symbol_level_pair_type, unary_tree_set_type, utils::hashxx<size_t>, std::equal_to<symbol_level_pair_type>,
					  std::allocator< std::pair<const symbol_level_pair_type, unary_tree_set_type> > >::type unary_tree_map_type;
    typedef typename utils::unordered_map<symbol_level_pair_type, unary_rule_set_type, utils::hashxx<size_t>, std::equal_to<symbol_level_pair_type>,
