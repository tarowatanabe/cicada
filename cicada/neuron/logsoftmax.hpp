...
#ifndef __CICADA__NEURON_LOGSOFTMAX__HPP__
#define __CICADA__NEURON_LOGSOFTMAX__HPP__ 1
...
namespace cicada
{
  namespace neuron
  {
    ...
    public:
      ...
      virtual layer_ptr_type clone(const bool share=false) const { return layer_ptr_type(new LogSoftMax(*this)); }
