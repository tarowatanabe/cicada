...
namespace cicada
{
  namespace eval
  {
    ...
    Score::score_ptr_type WER::decode(utils::piece::const_iterator& iter, utils::piece::const_iterator end)
    {
	...
	return score_ptr_type();
      ...
      std::unique_ptr<WER> wer(new WER());
    ...
    Score::score_ptr_type WER::decode(const utils::piece& encoded)
    {
