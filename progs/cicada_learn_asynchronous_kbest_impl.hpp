...
#ifndef __CICADA_LEARN_ASYNCHRONOUS_KBEST_IMPL__HPP__
#define __CICADA_LEARN_ASYNCHRONOUS_KBEST_IMPL__HPP__ 1
...
struct LearnPA : public LearnOnlineMargin
{
  ...
  double learn(weight_set_type& weights, feature_set_type& updates)
  {
	...
	updates[fiter->first] += alpha * fiter->second;
      }
...
struct KBestSentence
{
  ...
  {    
	...
	kbest_derivations(derivations, kbests);
      } else {
  ...
  void kbest_derivations(const Derivations& derivations, hypothesis_set_type& kbests)
  {
