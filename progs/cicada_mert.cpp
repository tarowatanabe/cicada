  ...
  try {
	...
	while (1) {
	  ...
	  if (weight_normalize_l1 || regularize_l1)
	    normalize_l1(sample_weights.begin(), sample_weights.end(), regularize_l1 ? 1.0 / C : 1.0);
	  else
	    normalize_l2(sample_weights.begin(), sample_weights.end(), regularize_l2 ? 1.0 / std::sqrt(C) : 1.0);
