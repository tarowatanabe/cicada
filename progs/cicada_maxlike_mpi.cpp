...
struct OptimizeLBFGS
{
				  ...
				  const lbfgsfloatval_t step)
  {
    ...
    task_type task(optimizer.graphs, optimizer.scorers, optimizer.features, optimizer.weights);
		...
		weight_set_type& weights)
{
  ...
  if (mpi_rank == 0) {
    const double objective = OptimizeLBFGS(graphs, scorers, features, weights)();
	...
	task_type task(graphs, scorers, features, weights);
