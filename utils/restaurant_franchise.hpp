...
#ifndef __UTILS__RESTAURANT_FRANCHISE__HPP__
#define __UTILS__RESTAURANT_FRANCHISE__HPP__ 1
...
//
// Chinese Restaurant_Franchise Process with optional customer and table tracking
...
//
//
// actually, we will use PYP process, not Dirichlet process...
//
...
namespace utils
{
  ...
  public:
    ...
    restaurant_franchise(const double& __discount,
    ...
    restaurant_franchise(const double& __discount_prior_alpha,
  ...
  private:    
    ...
    {
      DiscountSampler(const restaurant_franchise& __crp) : crp(__crp) {}
      
      const restaurant_franchise& crp;
    ...
    {
      StrengthSampler(const restaurant_franchise& __crp) : crp(__crp) {}
