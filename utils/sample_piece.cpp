...
int main(int argc, char** argv)
{
  ...
  std::cout << "piece1: " << pie1 << std::endl
	    << "piece2: " << pie2 << std::endl;
  
  std::cout << "piece1 substr: " << pie1.substr(5) << std::endl
	    << "piece2 substr: " << pie2.substr(4) << std::endl
