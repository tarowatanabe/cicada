...
#ifndef __UTILS__TRIE_DENSE__HPP__
#define __UTILS__TRIE_DENSE__HPP__ 1
...
namespace utils
{
  ...
  class trie_dense : public __trie_dense_base
  {
  public:
  ...
  public:
    trie_dense(const key_type& __empty) { __root.set_empty_key(__empty); }
...
namespace std
{
  ...
  inline
  void swap(utils::trie_dense<Key,Data,Hash,Equal,Alloc>& x,
	    utils::trie_dense<Key,Data,Hash,Equal,Alloc>& y)
  {
    x.swap(y);
  }
};
