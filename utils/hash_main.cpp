...
int main(int argc, char** argv)
{
  ...
  {
    utils::resource start;
    test_hash_loop<128>::test(gen, utils::hashxx<uint32_t>(), utils::hashxx<uint64_t>());
    utils::resource end;
  ...
  {
    utils::resource start;
    test_hash_loop<128>::test(gen, utils::hashmurmur<uint32_t>(), utils::hashmurmur<uint64_t>());
    utils::resource end;
  ...
  {
    utils::resource start;
    test_hash_loop<128>::test(gen, utils::hashmurmur3<uint32_t>(), utils::hashmurmur3<uint64_t>());
    utils::resource end;
