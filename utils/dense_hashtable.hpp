...
namespace utils
{
  ...
  public:
    ...
    dense_hashtable() : hashtable() {  hashtable.set_empty_key(0); hashtable.set_deleted_key(1); }
    dense_hashtable(const dense_hashtable& x) : hashtable() { hashtable.set_empty_key(0); hash_table.set_deleted_key(1); assign(x); }
