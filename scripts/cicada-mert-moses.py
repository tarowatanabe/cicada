...
opt_parser = OptionParser(
    ...
    make_option("--parameter-lower", default=-2.0, action="store", type="float",
                help="lower parameter value (default: -2)"),
    make_option("--parameter-upper", default=2.0, action="store", type="float",
                help="upper parameter value (default: 2)"),
